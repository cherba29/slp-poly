...
//   moduleLogLevels; for (int i = 0; i < logging::LogModuleEnum::NUM_ENUMS;
//   i++) {
...
::util::MultiIndexMap& operator<<(::util::MultiIndexMap& m,
  ...
  if (iprof) {
    ...
    interp_m["vandermonde"]["solver"] =
        iprof->getVandermondeSolver().toString();
