...
public:
  ...
  InterpProfile():
    ...
    void setUnivInterpAlg(const interp::UnivInterpEnum& val) { univInterpAlg_ = val; }
    const interp::UnivInterpEnum& getUnivInterpAlg() const { return univInterpAlg_; }

    const interp::VandSolveTypeEnum& getVandermondeSolver() const { return vandSolver_; }
    void setVandermondeSolver(const interp::VandSolveTypeEnum& val) { vandSolver_ = val; }

    const interp::PrunningEnum& getPrunningChoice() const { return prunningChoice_; }
    void setPrunningChoice(const interp::PrunningEnum& val) { prunningChoice_ = val; }

    const boost::optional<std::string> getSaveFileName() const { return saveFileName_; }
    ...
    const boost::optional<std::string>& getAsmFileName() const { return asmFileName_; }
