...
/*****************************************************************************/
/**
 * @brief convert nul terminated decimal string (without spaces) to a field element
...
void setFill(F* dest, const F& val, int count) {
...
/*****************************************************************************/
template <typename F> inline
void setFill2P(F* dest, const F& val, int size) {
