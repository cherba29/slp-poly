...
// Field_uint<UIntType,MOD>::Field_uint(typename
// Field_uint<UIntType,MOD>::ubase_type v) {
//  val_ = v % MOD;
//}
//*****************************************************************************
template <typename UIntType, UIntType MOD>
__forceinline Field_uint<UIntType, MOD>::Field_uint(
    typename Field_uint<UIntType, MOD>::sbase_type v) {
  val_ = (v < 0) ? (MOD - ((-v) % MOD)) : v % MOD;
}
//*****************************************************************************
template <typename UIntType, UIntType MOD>
__forceinline void Field_uint<UIntType, MOD>::setTo(
    typename Field_uint<UIntType, MOD>::sbase_type v) {
  if (v < 0) {
...
//*****************************************************************************
template <typename UIntType, UIntType MOD>
__forceinline Field_uint<UIntType, MOD>& Field_uint<UIntType, MOD>::operator+=(
    const Field_uint<UIntType, MOD>& right) {
...
template <typename UIntType, UIntType MOD>
__forceinline Field_uint<UIntType, MOD> Field_uint<UIntType, MOD>::operator+(
    const Field_uint<UIntType, MOD>& right) const {
...
//*****************************************************************************
template <typename UIntType, UIntType MOD>
__forceinline Field_uint<UIntType, MOD>& Field_uint<UIntType, MOD>::random() {
  val_ = math::random<typename Field_uint::ubase_type>::get() % MOD;
  return *this;
}
//*****************************************************************************
template <typename UIntType, UIntType MOD>
__forceinline Field_uint<UIntType, MOD>&
Field_uint<UIntType, MOD>::invertableRandom() {
  do {
    random();
  } while (is<0>());
  return *this;
...
//*****************************************************************************
template <typename UIntType, UIntType MOD>
__forceinline void Field_uint<UIntType, MOD>::divide(
    Field_uint<UIntType, MOD>* dest, const Field_uint<UIntType, MOD>& src1,
    const Field_uint<UIntType, MOD>& src2) {
  Field_uint<UIntType, MOD>::multiply(dest, src1, src2.getInverse());
}
//*****************************************************************************
template <typename UIntType, UIntType MOD>
__forceinline bool Field_uint<UIntType, MOD>::operator==(
    const Field_uint<UIntType, MOD>& right) const {
...
template <typename UIntType, UIntType MOD>
__forceinline Field_uint<UIntType, MOD>& Field_uint<UIntType, MOD>::operator*=(
    const Field_uint<UIntType, MOD>& m) {
  typename TypeInfo<UIntType>::unsigned2x_type q = val_;
  q *= m.val_;
  val_ = q % MOD;
  return *this;
...
//*****************************************************************************
template <typename UIntType, UIntType MOD>
__forceinline Field_uint<UIntType, MOD> Field_uint<UIntType, MOD>::getPow(
    ubase_type p) const {
  Field_uint<UIntType, MOD> A;
  if (p == 1) {
    A.val_ = val_;
...
//*****************************************************************************
template <typename UIntType, UIntType MOD>
__forceinline Field_uint<UIntType, MOD>& Field_uint<UIntType, MOD>::sqr() {
  typename TypeInfo<UIntType>::unsigned2x_type q = val_;
  q *= val_;
  val_ = q % MOD;
  return *this;
...
//*****************************************************************************
template <typename UIntType, UIntType MOD>
__forceinline Field_uint<UIntType, MOD>& Field_uint<UIntType, MOD>::invert() {
...
//*****************************************************************************
template <typename UIntType, UIntType MOD>
__forceinline Field_uint<UIntType, MOD>& Field_uint<UIntType, MOD>::powerBy(
    unsigned int p) {
  if (p == 1) {
    return *this;
  }
...
//*****************************************************************************
template <typename UIntType, UIntType MOD>
__forceinline Field_uint<UIntType, MOD> Field_uint<UIntType, MOD>::getSqrt()
    const {
  Field_uint<UIntType, MOD> a;
...
//*****************************************************************************
template <typename UIntType, UIntType MOD>
__forceinline void Field_uint<UIntType, MOD>::multiply(
    Field_uint<UIntType, MOD>* dest, const Field_uint<UIntType, MOD>& src1,
    const Field_uint<UIntType, MOD>& src2) {
...
//*****************************************************************************
template <typename UIntType, UIntType MOD>
__forceinline void Field_uint<UIntType, MOD>::add(
    Field_uint<UIntType, MOD>* dest, const Field_uint<UIntType, MOD>& src1,
    const Field_uint<UIntType, MOD>& src2) {
...
//*****************************************************************************
template <typename UIntType, UIntType MOD>
__forceinline void Field_uint<UIntType, MOD>::subtract(Field_uint* dest,
...
//*****************************************************************************
template <typename UIntType, UIntType MOD>
__forceinline void Field_uint<UIntType, MOD>::neg(
    Field_uint<UIntType, MOD>* dest, const Field_uint<UIntType, MOD>& src) {
  if (src.val_) {
...
//*****************************************************************************
template <typename UIntType, UIntType MOD>
__forceinline void Field_uint<UIntType, MOD>::pow(
    Field_uint<UIntType, MOD>* dest, const Field_uint<UIntType, MOD>& src,
    unsigned int p) {
  if (p == 1) {
    dest->val_ = src.val_;
...
//*****************************************************************************
template <typename UIntType, UIntType MOD>
__forceinline Field_uint<UIntType, MOD>* Field_uint<UIntType, MOD>::alloc(
    unsigned int size) {
  return new Field_uint[size];
}
//*****************************************************************************
template <typename UIntType, UIntType MOD>
__forceinline void Field_uint<UIntType, MOD>::dealloc(Field_uint* p) {
  delete[] p;
}
//*****************************************************************************
template <typename UIntType, UIntType MOD>
__forceinline Field_uint<UIntType, MOD>* Field_uint<UIntType, MOD>::allocSq(
    unsigned int size) {
  return new Field_uint[size * size];
}
//*****************************************************************************
template <typename UIntType, UIntType MOD>
__forceinline Field_uint<UIntType, MOD>* Field_uint<UIntType, MOD>::allocSq2p(
    unsigned int size) {
...
template <typename UIntType, UIntType MOD>
Field_uint<UIntType, MOD> Field_uint<UIntType, MOD>::primRoots[
    // fourier_order<Field_uint<UIntType,MOD>::sbase_type,MOD>::ORDER
    sizeof(Field_uint<UIntType, MOD>::sbase_type) * 8];

template <typename UIntType, UIntType MOD>
Field_uint<UIntType, MOD> Field_uint<UIntType, MOD>::primRootInvs[
    // fourier_order<Field_uint<UIntType,MOD>::sbase_type,MOD>::ORDER
    sizeof(Field_uint<UIntType, MOD>::sbase_type) * 8];
...
bool Field_uint<UIntType, MOD>::init() {
  if (!Field_uint<UIntType, MOD>::initialized) {
    computePrimitiveRoots<Field_uint<UIntType, MOD> >(
        Field_uint<UIntType, MOD>(-1), primRoots, primRootInvs,
        sizeof(Field_uint<UIntType, MOD>::sbase_type) * 8
        // fourier_order<Field_uint<UIntType,MOD>::sbase_type,MOD>::ORDER
    );
  }
...
void Field_uint<UIntType, MOD>::toString(char* buffer) const {
  ...
  snprintf
      ...
      (buffer, getMaxStringRepLength(), formatStr,
       (val_ <= POS) ? static_cast<long>(val_)
