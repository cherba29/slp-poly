...
//Field_uint2x<UIntType,MOD1,MOD2>::Field_uint2x(typename Field_uint2x<UIntType,MOD1,MOD2>::ubase_type v) {
//  val1_ = v % MOD1;
//  val2_ = v % MOD2;
//}
//*****************************************************************************
template <typename UIntType, UIntType MOD1, UIntType MOD2> __forceinline
Field_uint2x<UIntType,MOD1,MOD2>::Field_uint2x(
...
//*****************************************************************************
template <typename UIntType, UIntType MOD1, UIntType MOD2> __forceinline
void Field_uint2x<UIntType,MOD1,MOD2>::setTo(
    typename Field_uint2x<UIntType,MOD1,MOD2>::sbase_type v) {
  if (v < 0) {
	val1_ = MOD1 - ((-v) % MOD1);
    val2_ = MOD2 - ((-v) % MOD2);
...
//*****************************************************************************
template <typename UIntType, UIntType MOD1, UIntType MOD2> __forceinline
Field_uint2x<UIntType,MOD1,MOD2>& Field_uint2x<UIntType,MOD1,MOD2>::operator+=(
...
//*****************************************************************************
template <typename UIntType, UIntType MOD1, UIntType MOD2> __forceinline
Field_uint2x<UIntType,MOD1,MOD2>& Field_uint2x<UIntType,MOD1,MOD2>::random() {
...
//*****************************************************************************
template <typename UIntType, UIntType MOD1, UIntType MOD2> __forceinline
Field_uint2x<UIntType,MOD1,MOD2>& Field_uint2x<UIntType,MOD1,MOD2>::invertableRandom() {
  do { random(); } while (!val1_ || !val2_);
  return *this;
}
//*****************************************************************************
template <typename UIntType, UIntType MOD1, UIntType MOD2> __forceinline
void Field_uint2x<UIntType,MOD1,MOD2>::divide(Field_uint2x<UIntType,MOD1,MOD2>* dest,
...
//*****************************************************************************
template <typename UIntType, UIntType MOD1, UIntType MOD2> __forceinline
bool Field_uint2x<UIntType,MOD1,MOD2>::operator==(
    const Field_uint2x<UIntType,MOD1,MOD2>& right) const {
...
//*****************************************************************************
template <typename UIntType, UIntType MOD1, UIntType MOD2> __forceinline
Field_uint2x<UIntType,MOD1,MOD2> Field_uint2x<UIntType,MOD1,MOD2>::operator-() const {
...
//*****************************************************************************
template <typename UIntType, UIntType MOD1, UIntType MOD2> __forceinline
Field_uint2x<UIntType,MOD1,MOD2> Field_uint2x<UIntType,MOD1,MOD2>::getPow(unsigned int p) const {
  Field_uint2x<UIntType,MOD1,MOD2> A;
...
//*****************************************************************************
template <typename UIntType, UIntType MOD1, UIntType MOD2> __forceinline
Field_uint2x<UIntType,MOD1,MOD2>& Field_uint2x<UIntType,MOD1,MOD2>::sqr() {
  typename TypeInfo<UIntType>::unsigned2x_type q1 = val1_;
  q1 *= val1_;
  val1_ = q1 % MOD1;
...
//*****************************************************************************
template <typename UIntType, UIntType MOD1, UIntType MOD2> __forceinline
Field_uint2x<UIntType,MOD1,MOD2>& Field_uint2x<UIntType,MOD1,MOD2>::invert() {
...
//*****************************************************************************
template <typename UIntType, UIntType MOD1, UIntType MOD2> __forceinline
Field_uint2x<UIntType,MOD1,MOD2>& Field_uint2x<UIntType,MOD1,MOD2>::powerBy(
    unsigned int p) {
  if (p == 1) {	return *this;	}
...
template <typename UIntType, UIntType MOD1, UIntType MOD2> __forceinline
Field_uint2x<UIntType, MOD1, MOD2> Field_uint2x<UIntType, MOD1, MOD2>::getSqrt() const {
...
//*****************************************************************************
template <typename UIntType, UIntType MOD1, UIntType MOD2> __forceinline
void Field_uint2x<UIntType,MOD1,MOD2>::multiply(
...
//*****************************************************************************
template <typename UIntType, UIntType MOD1, UIntType MOD2> __forceinline
void Field_uint2x<UIntType,MOD1,MOD2>::add(
    Field_uint2x<UIntType, MOD1, MOD2>* dest,
    const Field_uint2x<UIntType, MOD1, MOD2>& src1,
    const Field_uint2x<UIntType, MOD1, MOD2>& src2) {
...
//*****************************************************************************
template <typename UIntType, UIntType MOD1, UIntType MOD2> __forceinline
void Field_uint2x<UIntType,MOD1,MOD2>::subtract(Field_uint2x<UIntType,MOD1,MOD2>* dest,
                                                const Field_uint2x<UIntType,MOD1,MOD2>& src1,
                                                const Field_uint2x<UIntType,MOD1,MOD2>& src2) {
...
//*****************************************************************************
template <typename UIntType, UIntType MOD1, UIntType MOD2> __forceinline
void Field_uint2x<UIntType,MOD1,MOD2>::neg(Field_uint2x<UIntType,MOD1,MOD2>* dest,
...
//*****************************************************************************
template <typename UIntType, UIntType MOD1, UIntType MOD2> __forceinline
void Field_uint2x<UIntType,MOD1,MOD2>::pow(Field_uint2x<UIntType,MOD1,MOD2>* dest,
                                           const Field_uint2x<UIntType,MOD1,MOD2>& src,
                                           unsigned int p) {
  if (p == 1) {
...
//*****************************************************************************
template <typename UIntType, UIntType MOD1, UIntType MOD2> __forceinline
Field_uint2x<UIntType,MOD1,MOD2>* Field_uint2x<UIntType,MOD1,MOD2>::alloc(unsigned int size) {
  return new Field_uint2x<UIntType,MOD1,MOD2>[size];
}
//*****************************************************************************
template <typename UIntType, UIntType MOD1, UIntType MOD2> __forceinline
void Field_uint2x<UIntType,MOD1,MOD2>::dealloc(Field_uint2x<UIntType,MOD1,MOD2>* p) {
  delete[] p;
}
//*****************************************************************************
template <typename UIntType, UIntType MOD1, UIntType MOD2> __forceinline
Field_uint2x<UIntType,MOD1,MOD2>* Field_uint2x<UIntType,MOD1,MOD2>::allocSq(unsigned int size) {
  return new Field_uint2x<UIntType,MOD1,MOD2>[size*size];
}
//*****************************************************************************
template <typename UIntType, UIntType MOD1, UIntType MOD2> __forceinline
Field_uint2x<UIntType,MOD1,MOD2>* Field_uint2x<UIntType,MOD1,MOD2>::allocSq2p(unsigned int size) {
  const unsigned int szLog = math::intlog(size);
  return new Field_uint2x<UIntType,MOD1,MOD2>[static_cast<unsigned int>(1)<<(szLog<<1)];
}
//*****************************************************************************

template <typename UIntType, UIntType MOD1, UIntType MOD2>
Field_uint2x<UIntType,MOD1,MOD2>
Field_uint2x<UIntType,MOD1,MOD2>::primRoots[
  min<Field_uint2x<UIntType,MOD1,MOD2>::fourier1::ORDER,
      Field_uint2x<UIntType,MOD1,MOD2>::fourier2::ORDER
     >::value
];
...
bool Field_uint2x<UIntType,MOD1,MOD2>::init() {
  if (!Field_uint2x<UIntType,MOD1,MOD2>::initialized) {
    computePrimitiveRoots<Field_uint2x<UIntType,MOD1,MOD2> >(
        Field_uint2x<UIntType,MOD1,MOD2>(-1),
        primRoots,
        primRootInvs,
...
template <typename UIntType, UIntType MOD1, UIntType MOD2>
bool Field_uint2x<UIntType,MOD1,MOD2>::initialized = Field_uint2x<UIntType,MOD1,MOD2>::init();
...
int Field_uint2x<UIntType,MOD1,MOD2>::toString(char* buffer) const {
  ...
  bool negated;
  if (radsp.second > MOD2 - radsp.second) negated = true;
  else if (radsp.second < MOD2 - radsp.second) negated = false;
  else negated = (radsp.first >= MOD1 - radsp.first);
